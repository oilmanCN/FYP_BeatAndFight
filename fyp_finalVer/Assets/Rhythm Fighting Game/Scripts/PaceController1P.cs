...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Pace Controller 1P")]
    public class PaceController1P : MonoBehaviour
    {
        #region Fields
        ...
        public PaceNoteObject1P noteObjectArchetype;

        [Tooltip("The list of Lane Controller objects that represent a lane for an event to travel down.")]
        public List<PaceLaneController1P> noteLanes = new List<PaceLaneController1P>();
        ...
        Stack<PaceNoteObject1P> noteObjectPool = new Stack<PaceNoteObject1P>();

        public static PaceController1P Instance { get; private set; }
        ...
        void Start()
        {
            ...
            for (int i = 0; i < rawEvents.Count; ++i)
            {
                ...
                {
                    PaceLaneController1P lane = noteLanes[j];
        ...
        public PaceNoteObject1P GetFreshNoteObject()
        {
            PaceNoteObject1P retObj;
            ...
            {
                retObj = GameObject.Instantiate<PaceNoteObject1P>(noteObjectArchetype);
            }
        ...
        public void ReturnNoteObjectToPool(PaceNoteObject1P obj)
        {
            if (obj != null)
            {
                obj.enabled = false;
