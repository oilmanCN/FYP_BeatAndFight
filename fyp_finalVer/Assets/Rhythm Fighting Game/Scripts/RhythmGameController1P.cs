...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Rhythm Game Controller 1P")]
    public class RhythmGameController1P : MonoBehaviour
    {
        #region Fields
        ...
        public NoteObject1P noteObjectArchetype;

        [Tooltip("The list of Lane Controller objects that represent a lane for an event to travel down.")]
        public List<LaneController1P> noteLanes = new List<LaneController1P>();
        ...
        Stack<NoteObject1P> noteObjectPool = new Stack<NoteObject1P>();

        public static RhythmGameController1P Instance { get; private set; }
        ...
        void Start()
        {
            ...
            for (int i = 0; i < rawEvents.Count; ++i)
            {
                ...
                {
                    LaneController1P lane = noteLanes[j];
        ...
        public NoteObject1P GetFreshNoteObject()
        {
            NoteObject1P retObj;
            ...
            {
                retObj = GameObject.Instantiate<NoteObject1P>(noteObjectArchetype);
            }
        ...
        public void ReturnNoteObjectToPool(NoteObject1P obj)
        {
            if (obj != null)
            {
                obj.enabled = false;
