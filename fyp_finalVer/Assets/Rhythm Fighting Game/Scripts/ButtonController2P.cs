...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Button Controller 2P")]
    public class ButtonController2P : MonoBehaviour
    {
        #region Fields

        [Tooltip("The lane to which this button will send signals.")]
        public PaceLaneController2P paceLaneController2P;
        ...
        void Start()
        {
            ...
            Color buttonColor = paceLaneController2P.color;
            ...
            textCom.text = paceLaneController2P.keyboardButtonPositive.ToString();
            textCom.text = paceLaneController2P.keyboardButtonNegetive.ToString();
