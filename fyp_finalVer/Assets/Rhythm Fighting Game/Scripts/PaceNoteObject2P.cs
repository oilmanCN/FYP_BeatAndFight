...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Pace Note Object 2P")]
    public class PaceNoteObject2P : MonoBehaviour
    {
        #region Fields
        ...
        // If active, the Lane Controller2P that this Note Object is contained by.
        PaceLaneController2P paceLaneController2P;

        // If active, the Rhythm Game Controller2P that controls the game this Note Object is found within.
        ...
        public void Initialize(KoreographyEvent evt, Color color, PaceLaneController2P laneCont, PaceController2P gameCont)
        {
            trackedEvent = evt;
            visuals.color = color;
            paceLaneController2P = laneCont;
            paceController2P = gameCont;
        ...
        {
            trackedEvent = null;
            paceLaneController2P = null;
            paceController2P = null;
        }
        ...
        void Update()
        {
            ...
            if (transform.position.x <= paceLaneController2P.DespawnX)
            {
                paceController2P.ReturnNoteObjectToPool(this);
                Reset();
            }
        }
        ...
        void UpdateHeight()
        {
            ...
            float targetUnitHeight = paceController2P.WindowSizeInUnits * 2f; // Double it for before/after.
        ...
        void UpdatePosition()
        {
            ...
            float samplesPerUnit = paceController2P.SampleRate / paceController2P.noteSpeed;
            ...
            Vector3 pos = paceLaneController2P.TargetPosition;
            pos.x -= (paceController2P.DelayedSampleTime - trackedEvent.StartSample) / samplesPerUnit;
        ...
        public bool IsNotePerfect()
        {
            ...
            int curTime = paceController2P.DelayedSampleTime;
            //int hitWindow = gameController1P.HitWindowSampleWidth;
        ...
        // Returns this Note Object to the pool which is controlled by the Rhythm Game Controller2P.  This
