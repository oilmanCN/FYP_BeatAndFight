...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Rhythm Game Controller 2P")]
    public class RhythmGameController2P : MonoBehaviour
    {
        #region Fields
        ...
        public NoteObject2P noteObjectArchetype;

        [Tooltip("The list of Lane Controller objects that represent a lane for an event to travel down.")]
        public List<LaneController2P> noteLanes = new List<LaneController2P>();
        ...
        Stack<NoteObject2P> noteObjectPool = new Stack<NoteObject2P>();

        public static RhythmGameController2P Instance { get; private set; }
        ...
        void Start()
        {
            ...
            //playingMusic.LoadSong(playingKoreo);
            ...
            for (int i = 0; i < rawEvents.Count; ++i)
            {
                ...
                {
                    LaneController2P lane = noteLanes[j];
        ...
        public NoteObject2P GetFreshNoteObject()
        {
            NoteObject2P retObj;
            ...
            {
                retObj = GameObject.Instantiate<NoteObject2P>(noteObjectArchetype);
            }
        ...
        public void ReturnNoteObjectToPool(NoteObject2P obj)
        {
            if (obj != null)
            {
                obj.enabled = false;
