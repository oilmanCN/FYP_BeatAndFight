...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Note Object 2P")]
    public class NoteObject2P : MonoBehaviour
    {
        #region Fields
        ...
        LaneController2P laneController2P;
        ...
        public void Initialize(KoreographyEvent evt, Color color, LaneController2P laneCont, RhythmGameController2P gameCont)
        {
            trackedEvent = evt;
            visuals.color = color;
            laneController2P = laneCont;
            gameController2P = gameCont;
        ...
        {
            trackedEvent = null;
            laneController2P = null;
            gameController2P = null;
        }
        ...
        void Update()
        {
            ...
            if (transform.position.x <= laneController2P.DespawnX)
            {
                gameController2P.ReturnNoteObjectToPool(this);
                Reset();
            }
        }
        ...
        void UpdateHeight()
        {
            ...
            float targetUnitHeight = gameController2P.WindowSizeInUnits * 2f; // Double it for before/after.
        ...
        void UpdatePosition()
        {
            ...
            float samplesPerUnit = gameController2P.SampleRate / gameController2P.noteSpeed;
            ...
            Vector3 pos = laneController2P.TargetPosition;
            pos.x -= (gameController2P.DelayedSampleTime - trackedEvent.StartSample) / samplesPerUnit;
        ...
        public bool IsNotePerfect()
        {
            ...
            int curTime = gameController2P.DelayedSampleTime;
