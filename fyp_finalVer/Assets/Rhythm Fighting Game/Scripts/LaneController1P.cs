...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Lane Controller 1P")]
    public class LaneController1P : MonoBehaviour
    {
        #region Fields
        ...
        public static LaneController1P Instance { get; private set; }
        ...
        public void Initialize(RhythmGameController1P controller)
        {
            gameController1P = controller;
        }
        ...
        int GetSpawnSampleOffset()
        {
            ...
            double spawnSecsToTarget = (double)spawnDistToTarget / (double)gameController1P.noteSpeed;

            // Figure out the samples to the target.
            return (int)(spawnSecsToTarget * gameController1P.SampleRate);
        }
        ...
        public void CheckNoteHit()
        {
            ...
            else if (trackedNotes.Count > 0 && trackedNotes.Peek().IsNoteGood())
            {
                ...
                //P1Movement.Instance.Anime1P.SetTrigger("ATTACK");
                //deltahit1P = Time.deltaTime;
                deltahit1P = Koreographer.Instance.GetMusicSecondsTime(RhythmGameController1P.Instance.audioCom.clip.name);
        ...
        void CheckSpawnNext()
        {
            ...
            int currentTime = gameController1P.DelayedSampleTime;
                   ...
                   laneEvents[pendingEventIdx].StartSample < currentTime + samplesToTarget)
            {
                ...
                NoteObject1P newObj = gameController1P.GetFreshNoteObject();
                newObj.Initialize(evt, color, this, gameController1P);
        ...
        {
            NoteJudged?.Invoke("Player1",judgement);
        }
