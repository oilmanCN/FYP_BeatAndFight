...
public class SkillController1P : MonoBehaviour
{
    ...
    public static SkillController1P Instance { get; private set; }
    ...
    void Update()
    {
        ...
        {
            SkillControllerServer.Instance.checkSkillAvailable(1, 1);
        }
        else if (Input.GetKeyDown(keyboardButtonSkill2))
        {
            SkillControllerServer.Instance.checkSkillAvailable(1, 2);
        }
        else if (Input.GetKeyDown(keyboardButtonSkill3)) 
        {
            SkillControllerServer.Instance.checkSkillAvailable(1, 3);
        }
    }
}
