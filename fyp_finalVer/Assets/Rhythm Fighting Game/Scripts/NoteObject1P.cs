...
{
    [AddComponentMenu("Koreographer/Demos/Rhythm Game/Note Object 1P")]
    public class NoteObject1P : MonoBehaviour
    {
        #region Fields
        ...
        LaneController1P laneController1P;
        ...
        public void Initialize(KoreographyEvent evt, Color color, LaneController1P laneCont, RhythmGameController1P gameCont)
        {
            trackedEvent = evt;
            visuals.color = color;
            laneController1P = laneCont;
            gameController1P = gameCont;
        ...
        {
            trackedEvent = null;
            laneController1P = null;
            gameController1P = null;
        }
        ...
        void Update()
        {
            ...
            if (transform.position.x >= laneController1P.DespawnX)
            {
                gameController1P.ReturnNoteObjectToPool(this);
                Reset();
            }
        }
        ...
        void UpdateHeight()
        {
            ...
            float targetUnitHeight = gameController1P.WindowSizeInUnits * 2f; // Double it for before/after.
        ...
        void UpdatePosition()
        {
            ...
            float samplesPerUnit = gameController1P.SampleRate / gameController1P.noteSpeed;
            ...
            Vector3 pos = laneController1P.TargetPosition;
            pos.x += (gameController1P.DelayedSampleTime - trackedEvent.StartSample) / samplesPerUnit;
        ...
        public bool IsNotePerfect()
        {
            ...
            int curTime = gameController1P.DelayedSampleTime;
